...
<div id="footer" class="clearfix">
    ...
    <div id="copyright">
		...
		<?php if ($graphene_settings['copy_text'] == '') : ?>
            <p>
            <?php _e('2011: <a target="blank" href="http://indianhorsedatabase.com/">www.indianhorsedatabase.com</a>', 'graphene'); ?>
            </p>
        <?php else : ?>
        	<?php 
...
<?php printf( __('Powered by %1$s'), '<a href="http://wordpress.org/">WordPress</a>'); ?>
        </p>
