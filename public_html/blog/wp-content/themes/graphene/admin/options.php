            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[slider_disable]" id="slider_disable" <?php if ($graphene_settings['slider_disable'] == true) echo 'checked="checked"' ?> value="true" data-toggleOptions="true" /></td>
                    </tr>
                </table>
                <table class="form-table<?php if ($graphene_settings['slider_disable'] == true) echo ' hide'; ?>">
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="graphene_settings[slider_type]" value="latest_posts" id="slider_type_latest_posts" <?php if ($graphene_settings['slider_type'] == 'latest_posts') {echo 'checked="checked"';} ?>/>
                            <label for="slider_type_latest_posts"><?php _e('Show latest posts', 'graphene'); ?></label>                            
                            <br />
                            <input type="radio" name="graphene_settings[slider_type]" value="random" id="slider_type_random" <?php if ($graphene_settings['slider_type'] == 'random') {echo 'checked="checked"';} ?>/>
                            <label for="slider_type_random"><?php _e('Show random posts', 'graphene'); ?></label>
                            <br />
                            <input type="radio" name="graphene_settings[slider_type]" value="posts_pages" id="slider_type_posts_pages" <?php if ($graphene_settings['slider_type'] == 'posts_pages') {echo 'checked="checked"';} ?>/>
                            <label for="slider_type_posts_pages"><?php _e('Show specific posts/pages', 'graphene'); ?></label>                            
                            <br />
                            <input type="radio" name="graphene_settings[slider_type]" value="categories" id="slider_type_categories" <?php if ($graphene_settings['slider_type'] == 'categories') {echo 'checked="checked"';} ?>/>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="graphene_settings[slider_animation]" id="slider_animation">
                                <option value="horizontal-slide" <?php if ($graphene_settings['slider_animation'] == 'slide') {echo 'selected="selected"';}?>><?php _e('Horizontal slide', 'graphene'); ?></option>
                                <option value="vertical-slide" <?php if ($graphene_settings['slider_animation'] == 'vertical-slide') {echo 'selected="selected"';}?>><?php _e('Vertical slide', 'graphene'); ?></option>
                                <option value="fade" <?php if ($graphene_settings['slider_animation'] == 'fade') {echo 'selected="selected"';}?>><?php _e('Fade', 'graphene'); ?></option>
                                <option value="none" <?php if ($graphene_settings['slider_animation'] == 'none') {echo 'selected="selected"';}?>><?php _e('No effect', 'graphene'); ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[slider_position]" id="slider_position" <?php if ($graphene_settings['slider_position'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>                    
                </table>
            </div>
        </div>
            ...
            <div class="panel-wrap inside">            	
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="graphene_settings[disable_homepage_panes]" id="disable_homepage_panes" <?php if ($graphene_settings['disable_homepage_panes']) {echo 'checked="checked"';} ?> value="true" data-toggleOptions="true" />
                        </td>
                    </tr>
                </table>
                <table class="form-table site-summary<?php if ($graphene_settings['disable_homepage_panes'] == true) echo ' hide'; ?>">
                	<tr>
                        ...
                        <td>
                            <input type="radio" name="graphene_settings[show_post_type]" value="latest-posts" id="show_post_type_latest-posts" <?php if ($graphene_settings['show_post_type'] == 'latest-posts') {echo 'checked="checked"';} ?>/>
                            <label for="show_post_type_latest-posts"><?php _e('Latest posts', 'graphene'); ?></label>
                            
                            <input type="radio" name="graphene_settings[show_post_type]" value="cat-latest-posts" id="show_post_type_cat-latest-posts" <?php if ($graphene_settings['show_post_type'] == 'cat-latest-posts') {echo 'checked="checked"';} ?>/>
                            <label for="show_post_type_cat-latest-posts"><?php _e('Latest posts by category', 'graphene'); ?></label>
                           
                            <input type="radio" name="graphene_settings[show_post_type]" value="posts" id="show_post_type_pages" <?php if ($graphene_settings['show_post_type'] == 'posts') {echo 'checked="checked"';} ?>/>
            ...
            <div class="panel-wrap inside">
                <table class="form-table">       	
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[hide_parent_content_if_empty]" id="hide_parent_content_if_empty" <?php if ($graphene_settings['hide_parent_content_if_empty'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row">
            ...
            <div class="panel-wrap inside">
                ...
                <table class="form-table">       	
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[alt_home_sidebar]" id="alt_home_sidebar" <?php if ($graphene_settings['alt_home_sidebar'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[alt_home_footerwidget]" id="alt_home_footerwidget" <?php if ($graphene_settings['alt_home_footerwidget'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[hide_top_bar]" id="hide_top_bar" <?php if ($graphene_settings['hide_top_bar'] == true) echo 'checked="checked"' ?> value="true" data-toggleOptions="true" /></td>
                    </tr>
                </table>
                <table class="form-table social-media-table<?php if ($graphene_settings['hide_top_bar'] == true) echo ' hide'; ?>">
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[hide_feed_icon]" id="hide_feed_icon" <?php if ($graphene_settings['hide_feed_icon'] == true) echo 'checked="checked"' ?> value="true" /></td>                                    
                    </tr> 	
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[social_media_new_window]" id="social_media_new_window" <?php if ($graphene_settings['social_media_new_window'] == true) echo 'checked="checked"' ?> value="true" /></td>                                    
                    </tr> 
                    <tr>
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[show_addthis]" id="show_addthis" <?php if ($graphene_settings['show_addthis'] == true) echo 'checked="checked"' ?> value="true" data-toggleOptions="true" /></td>
                    </tr>
                </table>
                <table class="form-table<?php if ($graphene_settings['slider_disable'] == true) echo ' hide'; ?>">                    
                    <tr>
                        <th scope="row"><label for="show_addthis_page"><?php _e('Show in Pages as well?', 'graphene'); ?></label></th>
                        <td><input type="checkbox" name="graphene_settings[show_addthis_page]" id="show_addthis_page" <?php if ($graphene_settings['show_addthis_page'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[show_adsense]" id="show_adsense" <?php if ($graphene_settings['show_adsense'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <label for="adsense_show_frontpage"><?php _e('Show ads on front page as well', 'graphene'); ?></label>
                        </th>
                        <td><input type="checkbox" name="graphene_settings[adsense_show_frontpage]" id="adsense_show_frontpage" <?php if ($graphene_settings['adsense_show_frontpage'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row">
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[show_ga]" id="show_ga" <?php if ($graphene_settings['show_ga'] == true) echo 'checked="checked"' ?> value="true" data-toggleOptions="true" /></td>
                    </tr>
                </table>                
            ...
            <div class="panel-wrap inside">
                <table class="form-table">       	
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[show_cc]" id="show_cc" <?php if ($graphene_settings['show_cc'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[hide_copyright]" id="hide_copyright" <?php if ($graphene_settings['hide_copyright'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="hide_return_top"><?php _e('Do not show the "Return to top" link', 'graphene'); ?></label></th>
                        <td><input type="checkbox" name="graphene_settings[hide_return_top]" id="hide_return_top" <?php if ($graphene_settings['hide_return_top'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                </table>
            </div>
        </div> 
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[print_css]" id="print_css" <?php if ($graphene_settings['print_css'] == true) echo 'checked="checked"' ?> value="true" data-toggleOptions="true" /></td>
                    </tr>
                </table>
                <table class="form-table<?php if ($graphene_settings['slider_disable'] == true) echo ' hide'; ?>">                    
                    <tr>
                        <th scope="row"><label for="print_button"><?php _e("Show print button as well?", 'graphene'); ?></label></th>
                        <td><input type="checkbox" name="graphene_settings[print_button]" id="print_button" <?php if ($graphene_settings['print_button'] == true) echo 'checked="checked"' ?> value="true" /></td>                        
                    </tr>
                </table>
            </div>
        </div>  
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[light_header]" id="light_header" <?php if ($graphene_settings['light_header'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <label for="link_header_img"><?php _e('Link header image to front page', 'graphene'); ?></label>
                        </th>
                        <td><input type="checkbox" name="graphene_settings[link_header_img]" id="link_header_img" <?php if ($graphene_settings['link_header_img'] == true) echo 'checked="checked"' ?> value="true" /><br />
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[featured_img_header]" id="featured_img_header" <?php if ($graphene_settings['featured_img_header'] == true) echo 'checked="checked"' ?> value="true" /><br />
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[use_random_header_img]" id="use_random_header_img" <?php if ($graphene_settings['use_random_header_img'] == true) echo 'checked="checked"' ?> value="true" /><br />
                            <span class="description">
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[hide_post_author]" id="hide_post_author" <?php if ($graphene_settings['hide_post_author'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row">
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[hide_post_cat]" id="hide_post_cat" <?php if ($graphene_settings['hide_post_cat'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <label for="hide_post_tags"><?php _e('Hide post tags', 'graphene'); ?></label>
                        </th>
                        <td><input type="checkbox" name="graphene_settings[hide_post_tags]" id="hide_post_tags" <?php if ($graphene_settings['hide_post_tags'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row">
                        ...
                        <td><input type="checkbox" name="graphene_settings[hide_post_commentcount]" id="hide_post_commentcount" <?php if ($graphene_settings['hide_post_commentcount'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="show_post_avatar"><?php _e("Show post author's gravatar", 'graphene'); ?></label></th>
                        <td><input type="checkbox" name="graphene_settings[show_post_avatar]" id="show_post_avatar" <?php if ($graphene_settings['show_post_avatar'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="show_post_author"><?php _e("Show post author's info", 'graphene'); ?></label></th>
                        <td><input type="checkbox" name="graphene_settings[show_post_author]" id="show_post_author" <?php if ($graphene_settings['show_post_author'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="panel-wrap inside">
            	<table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[posts_show_excerpt]" id="posts_show_excerpt" <?php if ($graphene_settings['posts_show_excerpt'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
                        <th scope="row">
                        ...
                        <td>
                        	<input type="checkbox" name="graphene_settings[archive_full_content]" id="archive_full_content" <?php if ($graphene_settings['archive_full_content'] == true) echo 'checked="checked"' ?> value="true" /><br />
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[show_excerpt_more]" id="show_excerpt_more" <?php if ($graphene_settings['show_excerpt_more'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                    <tr>
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[hide_allowedtags]" id="hide_allowedtags" <?php if ($graphene_settings['hide_allowedtags'] == true) echo 'checked="checked"' ?> value="true" /></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="panel-wrap inside">
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="graphene_settings[disable_menu_desc]" id="disable_menu_desc" <?php if ($graphene_settings['disable_menu_desc'] == true) echo 'checked="checked"' ?> value="true" data-toggleOptions="true" /></td>
                    </tr>
                </table>
                <table class="form-table<?php if ($graphene_settings['slider_disable'] == true) echo ' hide'; ?>">
                    <tr>
    ...
    <div class="postbox">
        ...
        <div class="panel-wrap inside">
            <table class="form-table">
                <tr>
                    <td>
                        <input type="checkbox" name="graphene_settings[enable_preview]" id="enable_preview" <?php if ($graphene_settings['enable_preview'] == true) echo 'checked="checked"' ?> value="true" />
