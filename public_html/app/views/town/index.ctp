...
function del(id) {
	if(confirm("Are You Sure To Delete ")) {
		window.location.href='<?php  echo $html->url('/town/delete/') ;?>'+id ;
	}
}
</script>
<?php
	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top" align="left" height="50" class="page_heading_small"><?php e($html->image('icon_control_panel.gif', array("border"=>"0",'alt'=>'','align'=>'absmiddle'))); ?>&nbsp;&nbsp; Town Manager</td>
					<td></td>
				</tr>
			</table>		
	    </td>
		...
		<td valign="top" align="left" class="box">
        	<form action="" method="post" name="frm">
        	  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <td align="center"><a href="<?php echo $html->url('/Town/add') ;?>" class="action_link"><strong> Add Town </strong></a></td>
                </tr>
					<?php
                        ...
                        <tbody>
                          <tr class="header_bgcolor" height="26">
                            <td width="3%" align="center" class="headertext">#</td>
							 <td width="" align="center" class="headertext">Town</td>
                          ...
                          <tr <?php if($a%2==0) { echo "class=even_tr"; } else {  echo "class=odd_tr"; } ?>>
                            ...
                            <td align="center" class="smalltext"><?php echo $val['Town']['town'] ;?></td>
							<td align="center" class="smalltext">
								<?php
								$statenamearr=$this->requestAction('/state/statename/'.$val['Town']['state_id']);
								e($statenamearr['State']['statename']);								
								?>
							</td>
                            <td align="center" class="smalltext">
							 	<?php echo date('d/m/Y', strtotime($val['Town']['posted_date'])); ?>                  
							 </td>		
							 <td align="center" class="smalltext"><?php
								if($val['Town']['status']=="Y") {										   												
									?>
								<a href="<?php e($html->url('/Town/stat_off/'.$val['Town']['id']));?>">
								<?php
								...
								?>
								<?php
								if($val['Town']['status']=="N") {										   												
									?>
									<a href="<?php e($html->url('/Town/stat_on/'.$val['Town']['id']));?>">
									<?php
							...
							<a href="<?php echo $html->url('/Town/edit/'.$val['Town']['id']) ;?>" class="view_link">						 
							 <?php e($html->image('icon_edit.gif', array('align'=>'absmiddle','border'=>'0','alt'=>'Edit','title'=>'Edit','class'=>'changeStatus'))); ?>
                              </a> &nbsp;|&nbsp; <a href="javascript:void(0)" class="view_link" onclick="del('<?php echo $val['Town']['id'] ;?>')">
