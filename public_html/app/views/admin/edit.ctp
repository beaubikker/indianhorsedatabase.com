	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top" align="left" height="50" class="page_heading_small"><?php e($html->image('icon_control_panel.gif', array("border"=>"0",'alt'=>'','align'=>'absmiddle'))); ?>&nbsp;&nbsp;Edit Admin Details Section</td>
					<td></td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td width="100%" align="center">
			<form name="user_add_trainer" id="user_add_trainer" method="post" action="">
				...
				<?php e($html->input('Admin/up_date',array("type"=>"hidden","value"=>date('Y-m-d',time())))); ?>
				<?php e($html->input('Admin/post_ip',array("type"=>"hidden","value"=>$_SERVER['REMOTE_ADDR']))); ?>
				...
				<table width="60%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				  <tr class="header_bgcolor" height="26">
					<td colspan="2" class="headertext"><b>&nbsp;Update Profile</b></td>
				  </tr>
				  <tr class="even_tr">
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<?php e($form->text('Admin.admin_login',array("type"=>"text","class"=>"look","size"=>"30"))); ?>
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<?php e($form->text('Admin.admin_first_name',array("type"=>"text","class"=>"look","size"=>"30"))); ?>
						 <br><span class="error"><?php echo $form->error('');?></span>
					</td>
				  </tr>
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<?php e($form->text('Admin.admin_middle_name',array("type"=>"text","class"=>"look","size"=>"30"))); ?>
						 <br><span class="error"><?php echo $form->error('');?></span>
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<?php e($form->text('Admin.admin_last_name',array("type"=>"text","class"=>"look","size"=>"30"))); ?>
						 <br><span class="error"><?php echo $form->error('');?></span>
					</td>
				  </tr>
				  <tr class="even_tr" style="padding:10px;">
					...
					<?php e($form->hidden('Admin.id',array("type"=>"text","class"=>"look","size"=>"30"))); ?>
					<?php e($form->text('Admin.admin_email',array("type"=>"text","class"=>"look","size"=>"30"))); ?>
						 <br><span class="error"><?php echo $form->error('');?></span>					
					</td>
				  </tr>
