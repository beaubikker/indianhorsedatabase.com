			  ...
			  <table width="84%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Stepbystep.stepname',array("class"=>"look","size"=>"30","maxlength"=>"16","value"=>$edit_arr['Stepbystep']['stepname'])); ?>
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						<?php
							 if($edit_arr['Stepbystep']['mainiamge']!="") {
								$imagedirectory="stepimages";
								$rootdirectory=$this->webroot;
								$target=180;
								$image=$edit_arr['Stepbystep']['mainiamge']; 
								...
								?>
								<img src="<?php e($this->webroot);?>img/stepimages/<?php e($image);?>" width="<?php e($width);?>" height="<?php e($height);?>">
								<?php
							}
							else {
								echo $img="<img src=".$this->webroot."img/noimage.jpeg height=180 width=291 border=0 >";
							}		
						?>
						<br>
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">						
						<?php
							 if($edit_arr['Stepbystep']['animated_image']!="") {
								$imagedirectory="animatedimated";
								$rootdirectory=$this->webroot;
								$target=180;
								$image=$edit_arr['Stepbystep']['animated_image']; 
								if (file_exists(rootpth()."/".$imagedirectory."/".$image)) {
									$imagearr=getimagesize(rootpth()."/".$imagedirectory."/".$image);	 
									$width=$imagearr[0];
									$height=$imagearr[1];
								...
								?>
								<img src="<?php e($this->webroot);?>img/animatedimated/<?php e($image);?>" width="<?php e($width);?>" height="<?php e($height);?>">
								<?php
							}
							else {
								echo $img="<img src=".$this->webroot."img/noimage.jpeg height=180 width=291 border=0 >";
