...
<div class="visitor" style="position:absolute; top:165px">
						...
						<div class="vis_mid">
							...
							?>
							<ul>
								<li><a href="<?php e($html->url('/user/freeuserwelcomepage'));?>">Dashboard</a></li>
								<li><a href="<?php e($html->url('/user/freeuserprofile'));?>">Personal Profile</a></li>
								<li><a href="<?php e($html->url('/user/userfreeuseaccount'));?>">Account Details</a></li>
								<li><a href="<?php e($html->url('/horse/addhorsebyfreemember'));?>">Add horse</a></li>
								<li><a href="<?php e($html->url('/horse/mylistedhorsefreemember'));?>">My Horses</a></li>								
							</ul>
