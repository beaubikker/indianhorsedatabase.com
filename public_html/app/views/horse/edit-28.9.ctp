			...
			<?php e($form->hidden('Horse.posted_date',array("value"=>date('Y-m-d')))); ?>			
				<table width="92%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				  ...
				  <tr class="even_tr">
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
								<?php 
								echo $form->text('Horse.name',array("size"=>"30","class"=>"look","onkeypress"=>"listingextinghorse()","autocomplete"=>"off","value"=>$useridarr[0]['Horse']['name'],"onchange"=>"chkhorse(".$horse_id.")")); ?>
								<input type="checkbox" name="data[Horse][nameunknownoption]" value="Y" id="nameunknownoption" <?php if($useridarr[0]['Horse']['nameunknownoption']=="Y") { ?> checked="checked" <?php } ?>><font color="#994F26"> Unknown</font>
								<span id="listhorse" style="overflow:visible; padding-left:65px"></span>
								<span id="horsemessage"></span>					</td>
				 </tr>	
				 <tr class="even_tr" style="padding:10px;">
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Horse.year',array("class"=>"look","size"=>"30","value"=>$useridarr[0]['Horse']['year'])); ?>
					 </td>
				 </tr>
					<?php 
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						<input type="radio" id="diedyes" name="data[Horse][deathstat]" value="Y" onClick="showdeathfild()" <?php if($useridarr[0]['Horse']['deathstat']=="Y") { ?> checked="checked" <?php } ?>>
									...
									<span id="deathfield" style="display:<?php e($show);?>;">	
										<br>	
										<p style="padding-bottom:5px;">Year of death :	</p>													
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Horse.sire',array("size"=>"30","class"=>"look","onkeypress"=>"listingextinghorsesire()","autocomplete"=>"off","value"=>$useridarr[0]['Horse']['sire'])); ?>
						 <span id="listsirehorse" style="overflow:visible;"></span>
						 <input type="checkbox" name="data[Horse][sireunknowoption]" value="Y" <?php if($useridarr[0]['Horse']['sireunknowoption']=="Y") { ?> checked="checked" <?php } ?>><font color="#994F26"> Unknown</font>
					 </td>
				 </tr>
				  <tr class="even_tr" style="padding:10px;">
					<td width="30%" align="left" valign="top" class="bold_text">Dam: </td>
					<td width="70%" align="left" valign="top" class="smalltext">
						<?php echo $form->text('Horse.dam',array("size"=>"30","class"=>"look","onkeypress"=>"listingextinghorsedam()","autocomplete"=>"off","value"=>$useridarr[0]['Horse']['dam'])); ?>
						<span id="listsiredam" style="overflow:visible;"></span>
						<input type="checkbox" name="data[Horse][damunknownoption]" value="Y" <?php if($useridarr[0]['Horse']['damunknownoption']=="Y") { ?> checked="checked" <?php } ?>><font color="#994F26"> Unknown</font>
					 </td>
				 </tr>
				 <tr class="even_tr" style="padding:10px;">
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 			<font color="#994F26">Yes</font> <input type="radio" name="data[Horse][registered]" value="Y" <?php if($useridarr[0]['Horse']['registered']=="Y") { ?> checked="checked" <?php } ?> onClick="showregister()">	
																			&nbsp;&nbsp;<font color="#994F26">No</font>
									...
									<div id="regcode" style="display:<?php e($showregister);?>;" align="left">	
										<br>
										<p>Number: </p>													
                                 		<input type="text" name="data[Horse][registration_code]" id="registrationcode" size="30" class="look" value="<?php e($useridarr[0]['Horse']['registration_code']);?>">  
										<br>
									</div> 
				   </td>
				 </tr>
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Horse.bloodline',array("class"=>"look","size"=>"30","value"=>$useridarr[0]['Horse']['bloodline'])); ?>
					 </td>
				 </tr> 	
				  <tr class="even_tr" style="padding:10px;">
					<td width="30%" align="left" valign="top" class="bold_text"> Breeder: </td>
					<td width="70%" align="left" valign="top" class="smalltext">
						<?php echo $form->text('Horse.breeder',array("size"=>"30","class"=>"look"," onkeypress"=>"listmemberall()","autocomplete"=>"off","value"=>$useridarr[0]['Horse']['breeder'])); ?>
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						<?php echo $form->text('Horse.ownername',array("size"=>"30","class"=>"look","onkeypress"=>"listmemberowner()","autocomplete"=>"off","value"=>$useridarr[0]['Horse']['ownername'])); ?>
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						<?php echo $form->text('Horse.stablename',array("size"=>"30","onkeypress"=>"liststable()","autocomplete"=>"off","value"=>$useridarr[0]['Horse']['stablename'])); ?>
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						<?php
							if($useridarr[0]['Horse']['image']!="") {
								e("<img src=".$this->webroot."img/horseimage/".$useridarr[0]['Horse']['image']." width=160 border=0 class=wrap>");
							}
							?>
						<br /><br />
					  ...
					  if(count($additionalimagearr)>0) {	 
								...
								foreach($additionalimagearr as $key=>$val):
									echo $img="<img src=".$this->webroot."img/horseadditionalimage/".$additionalimagearr[$key]['Horseimage']['image']." width=80 border=0 class=wrap>";
									?>										
									  <a href="<?php echo $html->url('/horse/deladdimage/'.$additionalimagearr[$key]['Horseimage']['id'].'/'.$additionalimagearr[$key]['Horseimage']['image']) ;?>" class="view_link">
				 ...
				 <tr class="even_tr" style="padding:10px;">
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Horse.prize_won',array("class"=>"look","size"=>"30","value"=>$useridarr[0]['Horse']['prize_won'])); ?>
					 </td>
				 </tr>
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						<select name="data[Horse][sales_status]" class="look">
						    ...
						    <option value="S" <?php if($useridarr[0]['Horse']['sales_status']=="S") { ?> selected="selected" <?php } ?>>For Sale </option>	
							<option value="Stud" <?php if($useridarr[0]['Horse']['sales_status']=="Stud") { ?> selected="selected" <?php } ?>>For Stud </option>	
							<option value="Notsale" <?php if($useridarr[0]['Horse']['sales_status']=="Notsale") { ?> selected="selected" <?php } ?>>Not For Sale </option>
						</select>						 
					</td>
				 </tr>		
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->textarea('Horse.other_details',array("class"=>"look","rows"=>"8","cols"=>"82","value"=>$useridarr[0]['Horse']['other_details'])); ?>
