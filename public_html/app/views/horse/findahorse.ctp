		...
		<div class="sub_body">			
				<div class="upper">
					...
					<div id="searchthreecolumntabsreyeng">
						<div <?php if($searchcriteria==""|| $searchcriteria=="Horse") { ?>class="personal_info22_active" <?php } else { ?> class="personal_info22" <?php } ?> id="horsearchtb" onClick="horsesearchtab()">Horses</div>
						...
						<div <?php if($searchcriteria=="Member")  { ?> class="email_confirmation22_active" <?php } else { ?> class="email_confirmation22" <?php } ?> id="breedersearchtb" onClick="findmembers()">Members</div>
							...
							<div class="profile_info_search">													
								...
								<input class="submit_btn_other" type="submit" value="Search"  name="horsesearch"/>
								<input class="submit_btn_other" type="button" value="Reset"  name="resethorseinfo" onClick="window.location.href='<?php e($html->url('/horse/findahorse'));?>'"/>								
								<div>&nbsp;</div>
								</div>
								<div class="po_inf_btm">&nbsp;</div>	</div>								
							  </span>
				...
				if($searchcriteria!="") {
					 ?>
					 	<span id="stablesearchresult"  style="display:none">
						<div class="profile_info">
						<div class="po_inf_up">&nbsp;</div>
						<div class="po_inf_mid">
							<?php
								...
								if(is_array($horslistarr)) {
									...
									?>
										<div class="pannel">
											...
											<div class="big2"><p class="kits"><span onClick="stabledetails('<?php e($val['Stable']['id']);?>')" style="cursor:pointer"><?php e($val['Stable']['stable_name']);?></span><br /><span>Date: <?php e(date('F Y', strtotime($val['Stable']['posted_date']))); ?></span></p></div>
				...
				if($searchcriteria!="") {
				 ?>
				 		<span id="membersearch" style="display:none">
						<div class="profile_info">
						<div class="po_inf_up">&nbsp;</div>
						<div class="po_inf_mid">
							<?php
								...
								if(is_array($horslistarr)) {
									...
									?>
										<div class="pannel">
											...
											<div class="big2"><p class="kits"><?php e($val['User']['firstname']);?><br /><span>Date: <?php e(date('F Y', strtotime($val['User']['registered_date']))); ?></span></p></div>
