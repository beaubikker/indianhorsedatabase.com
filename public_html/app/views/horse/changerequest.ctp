...
<script type="text/javascript">	
	...
	function hiddownervalnull() {
		document.getElementById("hiddownerid").value="";	
		blankallautocomplete();
	}
	function hiddbredervalnull() {
		document.getElementById("hiddbrederid").value="";	
		blankallautocomplete();
	}	
	function addpicture() {
		$("#changepic").toggle("slow");	
	...
	function listmemberowner() {
		...
		function assignmember(firstname,lastname,breederid) {
			document.getElementById("hiddbrederid").value=breederid;
...
<body onLoad="showmulimage();">		
	...
	<input type="hidden" name="hiddbrederid" id="hiddbrederid" value="<?php e($useridarr[0]['Horse']['breeder_id']);?>">	
	<input type="hidden" name="hiddstableid" id="hiddstableid" value="<?php e($useridarr[0]['Horse']['stable_id']);?>">
						  ...
						  <div class="form_box" id="deathfield" style="margin-bottom: 10px; display:<?php e($show);?>;">
							...
							<div class="form_box">
								<label class="formarea">Sire:</label>								 
								 ...
								 <div class="clear"></div>
								 <div align="right"><input type="checkbox" name="data[Horse][sireunknowoption]" value="Y" <?php if($useridarr[0]['Horse']['sireunknowoption']=="Y") { ?> checked="checked" <?php } ?> onClick="disablesire()" id="sireunknowoption"><font color="#994F26"> Unknown</font></div>
							</div>
							...
							<div class="form_box" id="regcode" style="margin-bottom: 10px; display:<?php e($showregister);?>">
								<label class="formarea"><strong style="padding-left: 10px;">Number</strong></label>								
                                 	<input type="text" name="data[Horse][registration_code]" id="registrationcode" size="30" value="<?php e($useridarr[0]['Horse']['registration_code']);?>" onClick="blankallautocomplete()">>                                 
							 </div>	
							...
							<div class="form_box">
								<label class="formarea">Breeder:</label><?php echo $form->text('Horse.breeder',array("size"=>"30","onkeypress"=>"listmemberall()","autocomplete"=>"off","value"=>$useridarr[0]['Horse']['breeder'],"onclick"=>"hiddbredervalnull()")); ?>
							...
							<div class="form_box">
								...
								<?php
								if($useridarr[0]['Horse']['ownerid']) {
									$ownername=$this->requestAction('/horse/username/'.$useridarr[0]['Horse']['ownerid']);
								}
								else {
									$ownername=$useridarr[0]['Horse']['ownername'] ;
								}
								?>
								<?php echo $form->text('Horse.ownername',array("size"=>"30","onkeypress"=>"listmemberowner()","autocomplete"=>"off","value"=>$ownername,"onclick"=>"hiddownervalnull()")); ?>
