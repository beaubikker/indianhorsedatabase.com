				...
				<div class="upper">
					...
					<div class="profile_info">
						...
						<div class="po_inf_mid">
							<h2 class="header2">Request Successfully Received</h2>	
							<p>Thank you for your input into the IHD. We will either approve or disapprove of your information depending on our feedback from other users.</p>												
						</div>
