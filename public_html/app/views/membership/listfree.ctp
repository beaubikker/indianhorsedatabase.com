...
function del(id) {
	if(confirm("Are You Sure To Delete ")) {
		window.location.href='<?php  echo $html->url('/Membership/delfreecontent/') ;?>'+id ;
	}
}
	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top" align="left" height="50" class="page_heading_small"><?php e($html->image('icon_control_panel.gif', array("border"=>"0",'alt'=>'','align'=>'absmiddle'))); ?>&nbsp;&nbsp; Listingfree Manager</td>
					<td></td>
				</tr>
			</table>		
	    </td>
        	...
        	<form action="" method="post" name="frm">
        	  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
				  ...
				  &nbsp;&nbsp;<a href="<?php echo $html->url('/Membership/addlistfree') ;?>" class="action_link"><strong>Add List Content For Free User </strong></a>
				    &nbsp;&nbsp;<a href="<?php echo $html->url('/Membership/listpaid') ;?>" class="action_link"><strong> List Content For Paid User </strong></a>				  </td>
                      ...
                      <table align="center" width="100%" border="0" cellspacing="1" cellpadding="2" class="header_bordercolor" >
                        <tbody>
                          ...
                          <tr <?php if($a%2==0) { echo "class=even_tr"; } else {  echo "class=odd_tr"; } ?>>
                            ...
                            <td align="center" class="smalltext"><?php echo $val['Listingfree']['contentname'] ;?></td>
                            <td align="center" class="smalltext">
							 	<?php echo date('d/m/Y', strtotime($val['Listingfree']['posted_date'])); ?>                  
							 </td>		
							 					
                            <td align="center" class="smalltext" nowrap="nowrap">
							<a href="<?php echo $html->url('/Membership/listfreeeditedit/'.$val['Listingfree']['id']) ;?>" class="view_link">						 
							 <?php e($html->image('icon_edit.gif', array('align'=>'absmiddle','border'=>'0','alt'=>'Edit','title'=>'Edit','class'=>'changeStatus'))); ?>
                              </a> &nbsp;|&nbsp; <a href="javascript:void(0)" class="view_link" onClick="del('<?php echo $val['Listingfree']['id'] ;?>')">
