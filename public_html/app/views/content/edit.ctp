...
<tr>
	<td>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td valign="top" align="left"  class="page_heading_small"><?php e($html->image('icon_control_panel.gif', array('border'=>'0','alt'=>'','align'=>'absmiddle'))); ?>&nbsp;Edit content Section </td>
			</tr> 
		</table>
	</td>
</tr>
			...
			<form name="frm" id="event" method="post" action="" enctype="multipart/form-data">	
			   <table width="84%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				  <tr class="header_bgcolor" height="26">
					<td colspan="2" class="headertext"><b>&nbsp;Edit Content  </b></td> 
				  </tr>
				  <tr class="even_tr">
					<td colspan="2" align="center" class="err"><b>Note</b> : * fields are mandatory.</td>
				  </tr>
				   <tr class="even_tr" style="padding:10px;">
					<td width="30%" align="left" valign="top" class="bold_text"><?=$form->label("Page Name ")?>  <span class="err">*</span> : </td>
					<td width="70%" align="left" valign="top" class="smalltext">					
					 <?php echo $form->text('Content.pagename',array("class"=>"look","size"=>"30","value"=>$edit_arr['Content']['pagename'])); ?>
					 	 <br><span class="error"><?php echo $form->error('');?></span>
					</td>
				 </tr>	
			
			 <tr class="even_tr" style="padding:10px;">
				<td width="30%" align="left" valign="top" class="bold_text" nowrap="nowrap"><?=$form->label("Company Name")?>  <span class="err">*</span> : </td>
				<td width="70%" align="left" valign="top" class="smalltext">
				
				<span class="error"><?php if(isset($err)){echo $err;}?></span><br>
				
					<?php echo $fck->Create('Content/content',$edit_arr['Content']['content'],'90%','300','Default'); ?>	
					<br>	 <span class="error"><?php echo $form->error(''); ?></span>	
				</td>	
			  </tr>		  
