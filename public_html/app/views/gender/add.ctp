...
<tr>
	<td>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td valign="top" align="left"  class="page_heading_small"><?php e($html->image('icon_control_panel.gif', array('border'=>'0','alt'=>'','align'=>'absmiddle'))); ?>&nbsp;Add Gender  </td>
			</tr> 
		</table>
	</td>
</tr>
			...
			<?php e($form->hidden('Gender.posted_date',array("value"=>date('Y-m-d')))); ?>			
				<table width="84%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				  <tr class="header_bgcolor" height="26">
					<td colspan="2" class="headertext"><b>&nbsp;Add Gender  </b></td>
				  </tr>				  
				  <tr class="even_tr">
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Gender.gender',array("class"=>"look","size"=>"30")); ?>
