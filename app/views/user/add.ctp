...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="100%" align="center">
			...
			<?php e($form->hidden('User.registered_date',array("value"=>date('Y-m-d')))); ?>			
				<table width="84%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <select name="data[User][usertype]" class="look">
						 	...
						 	<option value="P" <?php if($usertype=="P") { ?> selected="selected" <?php } ?>>Paid </option>
						 	<option value="F" <?php if($usertype=="F") { ?> selected="selected" <?php } ?>>Free </option>
						 </select>						 
				  ...
				  <tr class="even_tr" style="padding:10px;">
					<td width="30%" align="left" valign="top" class="bold_text">Firstname <span class="err">*</span> : </td>
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('User.firstname',array("class"=>"look","size"=>"30")); ?>
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('User.lastname',array("class"=>"look","size"=>"30")); ?>
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('User.email_address',array("class"=>"look","size"=>"30")); ?>
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->password('User.password',array("class"=>"look","size"=>"30")); ?>
