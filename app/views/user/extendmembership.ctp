	...
	<div id="wrapper_parrent">		
		...
		<div class="sub_body">			
				<div class="upper">
					...
					<form action="<?php e($html->url('/user/paymentformemshipextension'));?>" method="post" name="updatemembership">			
					<div class="profile_info">
								<h2 class="header2">Extend Membership
								<br>(Your membership is for <?php e($userarr['User']['expiration_time_periode']);?> And Will expire on <?php e(date('d F Y', strtotime($userarr['User']['membership_exipre_date']))); ?>)
								<?php
								if($userarr['User']['payment_status']=='N') {
									e("<br>Your Payment Status is : No");
								}
								?>
								</h2>
					  <div class="box1">								
