			  ...
			  <div>&nbsp;</div>	
					...
					<div class="profile_info">
						...
						<div class="po_inf_mid">
							<div align="center" style="padding-left:550px;"><input class="submit_btn9" type="button" value="Edit"  onClick="window.location.href='<?php e($html->url('/user/account'));?>'"/></div>
							...
							<div class="classified">
								...
								<ul>
									...
									if(count($ownerhorse_allarr)>=8) {
										?>
											<div align="center"><a class="viewallowned" href="javascript:void(0)" style="background:url(http://indianhorses.india-web-design.com/app/webroot/img/sub_big_btn.png) no-repeat 0 1px; border: medium none; color: #000000;font-family: verdana; font-size: 14px; font-weight: bold; width:183px; height:25px; text-align:right; text-decoration:none; cursor:pointer">View All</a></div>
										<?php
									}
									?>						
								</ul>
								...
								<ul>
									...
									if(count($allbreddnamearr)>=8) {
										?>
											<div align="center"><a class="viewallbred" href="javascript:void(0)" style="background:url(http://indianhorsedatabase.com/app/webroot/img/sub_big_btn.png) no-repeat 0 1px; border: medium none; color: #000000;font-family: verdana; font-size: 14px; font-weight: bold; width:183px; height:25px; text-align:center; text-decoration:none; cursor:pointer">View All</a></div>
										<?php
									}
									?>								
								</ul>							
