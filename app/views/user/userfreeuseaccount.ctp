		...
		{					
			...
			{		
				if(req.responseText==1) {		
					window.location.href='<?php e($html->url('/user/userfreeuseaccount'));?>'
				}		
				else {
				...
				<div class="upper">
					...
					<div class="profile_info">
						...
						<div class="po_inf_mid">	
							...
							<div class="ihd25">					
								<h3 class="big90">Upgrade to Premium </h3>
								<a href="<?php e($html->url('/user/updatemembership'));?>" class="big91">Change</a>
								<hr class="line_base" />
								<p class="big92"><span class="sub52"></span></p>
							</div>							
							<div class="ihd25">					
								<h3 class="big90">Edit Profile</h3>
								<a href="<?php e($html->url('/user/useraccount'));?>" class="big91">Edit</a>
								<hr class="line_base" />
								<p class="big92"><span class="sub52"></span></p>
							</div>													
						</div>
