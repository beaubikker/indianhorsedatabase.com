				...
				<table width="84%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				  ...
				  <tr class="even_tr">
				   ...
				   <tr class="even_tr" style="padding:10px;">
					<td width="30%" align="left" valign="top" class="bold_text">Product Type Name <span class="err">*</span> : </td>
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Producttype.producttype',array("class"=>"look","size"=>"30","value"=>$edit_arr['Producttype']['producttype'])); ?>
					 	 <br><span class="error"><?php echo $form->error('Producttype.producttype');?>
						 <?php
						 if($duplicateerr>0) {
				 ...
				 <tr class="even_tr" style="padding:10px;">
					<td width="30%" align="left" valign="top" class="bold_text">Product Type Description <span class="err">*</span> : </td>
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->textarea('Producttype.typedescription',array("class"=>"look","rows"=>"15","cols"=>65,"value"=>$edit_arr['Producttype']['typedescription'])); ?>
					</td>
				 </tr>
				  ...
				  <tr class="even_tr">
					...
					<td align="left" class="bold_text" valign="top">
						...
						&nbsp;&nbsp;&nbsp;
						<input type="button" class="button" value="Cancel" onClick="javascript: location.href='<?php echo $html->url('/producttype') ;?>'" />					</td>
				  </tr>
  			  </table>
			</form>
		</td>
