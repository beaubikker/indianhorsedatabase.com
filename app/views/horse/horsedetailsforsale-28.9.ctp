...
<body>		
	<div id="wrapper_parrent">		
		...
		<div class="sub_body">			
				<div class="upper">
					...
					<?php
					if(count($salecountarr)>0) {
					?>
					<h3 class="horse_salehead"><strong><?php e($horsearr['Horse']['name']);?> is for sale</strong></h3>
					<div class="profile_info">						
						<div class="po_inf_up">&nbsp;</div>
						<div class="po_inf_mid">
							<div class="form_box10" style="float: left;">
								<label><strong>Owner :</strong></label>
										<?php
										$username=$this->requestAction('/user/username/'.$horsearr['Horse']['ownerid']);
										e($username['User']['firstname']);
										?>			
								<div class="clear"></div>
							</div>	
							<div class="form_box10" style="float: left;">
								<label><strong>Price :</strong></label>
								 <?php e($pricerangefromarr[0]['Pricerange']['pricefrom']);?>-<?php e($pricerangetoarr[0]['Pricerange']['pricetoo']);?>							
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
							<div class="form_box10" style="float: left;">
								<label><strong>Contact details :</strong></label> <?php e($salecount[0]['Horsesale']['contactdetails']);?> 							
								<div class="clear"></div>
							</div>
							<div class="form_box10" style="float: left;">
								<label><strong>Description :</strong></label> <?php e($salecount[0]['Horsesale']['salesdescription']);?>			
								<div class="clear"></div>
							</div>					
						</div>
					...
					?>
					<?php
					if(count($studcountarr)>0) {
					?>	
					<h3 class="horse_salehead"><strong><?php e($horsearr['Horse']['name']);?> is standing at Stud</strong></h3>														
					<div class="profile_info">						
						<div class="po_inf_up">&nbsp;</div>						
						<div class="po_inf_mid">
							<div class="form_box10" style="float: left;">
								<label><strong>Price :</strong></label>
								<?php
								$pricefrom=$this->requestAction('/pricerange/pricerangename/'.$studcountarr[0]['Horseforstud']['pricerange_fromid']);
								$priceto=$this->requestAction('/pricerange/pricerangename/'.$studcountarr[0]['Horseforstud']['pricerange_toid']);								
								?>
								 <?php e($pricefrom['Pricerange']['pricefrom']);?>-<?php e($priceto['Pricerange']['pricetoo']);?>							
								<div class="clear"></div>
							</div>
							<div class="form_box10" style="float: left;">
								<label><strong>Owner :</strong></label>
							...
							<div class="clear"></div>	
							<div class="form_box10" style="float: left;">
								<label><strong>Stud Description :</strong></label> <?php e($studcountarr[0]['Horseforstud']['stud_details']);?>			
								<div class="clear"></div>
							</div>
							<div class="form_box10" style="float: left;">
								<label><strong>Contact details :</strong></label> <?php e($studcountarr[0]['Horseforstud']['contact_details']);?> 							
								<div class="clear"></div>
							</div>					
						</div>						
						<div class="po_inf_btm">&nbsp;</div>						
					...
					<div class="pannel0" style="position: absolute;width: 270px; right: 0; top: -5px; margin-left: 0;" >
					  ...
					  <div style="position: absolute; width: 400px; right: -25px; top: 70px;">							
					   ...
					   ?>
							...
							?>
							<div class="line_para">
								<div class="same"><p>Year of death</p></div>
								<div class="same"><span class="dot">-</span></div>
								<div class="same"><p class="domen">
								<?php 
								if($horsearr['Horse']['yearofdeath']!="") {
			...
			?>
							...
							?>
							<div class="line_para">
								<div class="same"><p>Number</p></div>
								<div class="same"><span class="dot">-</span></div>
								<div class="same"><p class="domen">&nbsp;</p></div>
							</div>
							<div class="line_para">
									...
									<div class="doom55" style="height: 20px; line-height: 20px; text-align: center; color: #CBB056; position: relative;">
										<div>
											<?php
											  ...
											  <div class="small_hirerchyfirst" id="hirerchyfifth" style="display:none; position: absolute; left: 30px; top: -160px; z-index: 100;" >
												<?php
	...
	<div class="small_boxsirefirstsire" id="smaallimageforfirstsire" style="display:none" >
			<?php
			if(count($firstsirenamearr)>0) {
			?>	
				<h3 class="toxic1"><?php e($firstsirenamearr[0]['Horse']['name']);?></h3>
					<?php
					$imagedirectory="horseimage";
					$image=$firstsirenamearr[0]['Horse']['image'] ;
					if($image!="") {
						if(file_exists(rootpth()."/".$imagedirectory."/".$image)) {
							$xy = $rsz->imgResize(rootpth()."horseimage/".$image,78,83);
						?>
					...
					?>			
				<h4 class="toxic3"><?php e($breedname=$this->requestaction('/horse/breedname/'.$firstsirenamearr[0]['Horse']['breed_id']));?><br /><?php e($firstsirenamearr[0]['Horse']['year']);?></h4>
				<p class="toxic4"></p>			
			<?php
			}
			?>
	...
	<div class="small_box" id="smaallimage1" style="display:none" >
			<?php
	...
	<div class="small_boxsire" id="smaallimagefordam1" style="display:none" >
			<?php			
	...
	<div style="display: none; width: 450px !important; padding-right: 0; margin-top: -160px; margin-left: -290px; height:auto" id="offsping" class="popup_block">
