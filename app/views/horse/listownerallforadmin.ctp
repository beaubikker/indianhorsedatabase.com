...
<div style="position:absolute; left:325px; height:<?php e($height);?>px; width:215px; overflow:auto; overflow-x:hidden; background:#fff;">
								<table align="center" width="215" class="listbox" cellspacing="0" cellpadding="4">
										<?php
										if(count($userarr)>0) {
