					...
					<div class="profile_info">
						...
						<div style="float:left;">
							<div class="form_box">
								...
								<?php echo $form->text('Horse.name',array("size"=>"30","onchange"=>"chkhorse()","onkeypress"=>"listingextinghorse()","autocomplete"=>"off","value"=>$horname,"class"=>"newinput","onclick"=>"blankallautocomplete()")); ?>
								...
								<div align="right"><input type="checkbox" name="data[Horse][nameunknownoption]" value="Y" id="nameunknownoption" onClick="namedis()"><font color="#994F26"> Unknown</font></div>
								<div class="clear"></div>
							</div>
							<div class="form_box">
						  ...
						  <div class="form_box">
								<label class="formarea">Year:</label>								
                                 	<input type="text" name="data[Horse][year]" id="year" size="15" onClick="blankallautocomplete()">
									<div class="clear"></div>                                         
						  </div>
						  ...
						  <!--<div class="form_box">
							...
							<div class="form_box">
								<label class="formarea">Sire:</label>
								 <?php echo $form->text('Horse.sire',array("size"=>"30","onkeypress"=>"listingextinghorsesire()","autocomplete"=>"off","onclick"=>"blanallapartfromsire()")); ?>
								 <br>
								 <span id="listsirehorse" style="overflow:visible;">								 
								 </span>
								 <div class="clear"></div>
								 <div align="right"><input type="checkbox" name="data[Horse][sireunknowoption]" value="Y" onClick="disablesire()" id="sireunknowoption"><font color="#994F26"> Unknown</font></div>
							</div>
							
							<div class="form_box">
								<label class="formarea">Dam:</label>
								<?php echo $form->text('Horse.dam',array("size"=>"30","onkeypress"=>"listingextinghorsedam()","autocomplete"=>"off","onclick"=>"blanallapartfromdam()")); ?>
								 <br>
								 <span id="listsiredam" style="overflow:visible;"></span>
								 <div class="clear"></div>
								 <div align="right"><input type="checkbox" name="data[Horse][damunknownoption]" value="Y" onClick="disabledam()" id="damunknownoption"><font color="#994F26"> Unknown</font></div>
								<div class="clear"></div>
							</div>
							...
							<div class="clear"></div>						
							<div class="form_box">
								<label class="formarea">Bloodline:</label><?php echo $form->text('Horse.bloodline',array("size"=>"30","onclick"=>"blankallautocomplete()")); ?>						
								<div class="clear"></div>
							</div>							
							<div class="form_box">
								<label class="formarea">Breeder:</label><?php echo $form->text('Horse.breeder',array("size"=>"30"," onkeypress"=>"listmemberall()","autocomplete"=>"off","onclick"=>"blankallautocomplete()")); ?>
								 <br>
							...
							<div class="form_box">
								...
								<?php echo $form->text('Horse.ownername',array("size"=>"30","onkeypress"=>"listmemberowner()","autocomplete"=>"off","onclick"=>"blankallautocomplete()")); ?>
								<br>
							...
							<div class="form_box">
								...
								<?php echo $form->text('Horse.stablename',array("size"=>"30","onkeypress"=>"liststable()","autocomplete"=>"off","onFocus"=>"nostable()","onclick"=>"blankallautocomplete()")); ?>
								<br>
							...
							<div class="form_box">
								...
								<?php echo $form->text('Horse.bred_name',array("size"=>"30","onkeypress"=>"listbred()","autocomplete"=>"off","onclick"=>"blankallautocomplete()")); ?>
								 <br>
							...
							<div class="form_box" style="height: 50px;">
								<label class="formarea">Prize won:</label><?php echo $form->textarea('Horse.prize_won',array('rows'=>'4','cols'=>'50','style'=>'border: 1px solid #F2CE87; position: absolute; height: 40px','class'=>'newtextarea',"onclick"=>"blankallautocomplete()")); ?>
								<div class="clear"></div>
							</div>
																		
							<div class="form_box" style="height: 150px;">
								<label class="formarea">Other details:</label><?php echo $form->textarea('Horse.other_details',array('rows'=>'8','cols'=>23,"class"=>"newtextarea","onclick"=>"blankallautocomplete()")); ?>				
								<div class="clear"></div>
							</div>
