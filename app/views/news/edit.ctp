				...
				<table width="84%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				  ...
				  <tr class="even_tr" style="padding:10px;">
						 ...
						 <select name="data[News][newstype]" class="look">
							...
							if(is_array($newstypearr)) {
								foreach($newstypearr as $key=>$val) :
									if($val['Newstype']['id']==$edit_arr['News']['newstype']) {
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('News.newstitle',array("class"=>"look","size"=>"30","value"=>$edit_arr['News']['newstitle'])); ?>
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $fck->Create('News/newsdesc',$edit_arr['News']['newsdesc'],'90%','300','Default'); ?>	
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						<?php
								if($edit_arr['News']['image']!="") {
									echo $img="<img src=".$this->webroot."img/newsimage/".$edit_arr['News']['image']." width=160 border=0 >";
								}
								e("<br>");
								?>
