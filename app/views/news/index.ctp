...
function del(id) {
	if(confirm("Are You Sure To Delete ")) {
		window.location.href='<?php  echo $html->url('/News/delete/') ;?>'+id ;
	}
}
	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top" align="left" height="50" class="page_heading_small"><?php e($html->image('icon_control_panel.gif', array("border"=>"0",'alt'=>'','align'=>'absmiddle'))); ?>&nbsp;&nbsp; News  Manager</td>
					<td></td>
				</tr>
			</table>		
	    </td>
		...
		<td valign="top" align="left" class="box">
        	<form action="" method="post" name="frm">
        	  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <td align="center"><a href="<?php echo $html->url('/news/add') ;?>" class="action_link"><strong> Add News </strong></a></td>
                </tr>
					<?php
                      ...
                      <table align="center" width="100%" border="0" cellspacing="1" cellpadding="2" class="header_bordercolor" >
                        <tbody>
                          <tr class="header_bgcolor" height="26">
                            ...
                            <td width="" align="center" class="headertext">News</td>
							<td width="" align="center" class="headertext">News Type </td>
                          ...
                          <tr <?php if($a%2==0) { echo "class=even_tr"; } else {  echo "class=odd_tr"; } ?>>
                            ...
                            <td align="center" class="smalltext"><?php echo $val['News']['newstitle'] ;?></td>
							<td align="center" class="smalltext">
								<?php
								$typearr=$this->requestAction('news/newstype/'.$val['News']['newstype']);
								e($typearr);
								?> 
							</td>
                            <td align="center" class="smalltext">
							 	<?php echo date('m/d/Y', strtotime($val['News']['posteddate'])); ?>                  
							 </td>		
							 <td align="center" class="smalltext"><?php
								if($val['News']['status']=="Y") {										   												
									?>
								<a href="<?php e($html->url('/News/stat_off/'.$val['News']['id']));?>">
								<?php
								...
								?>
								<?php
								if($val['News']['status']=="N") {										   												
									?>
									<a href="<?php e($html->url('/News/stat_on/'.$val['News']['id']));?>">
									<?php
							...
							<a href="<?php echo $html->url('/News/edit/'.$val['News']['id']) ;?>" class="view_link">						 
							 <?php e($html->image('icon_edit.gif', array('align'=>'absmiddle','border'=>'0','alt'=>'Edit','title'=>'Edit','class'=>'changeStatus'))); ?>
                              </a> &nbsp;|&nbsp; <a href="javascript:void(0)" class="view_link" onclick="del('<?php echo $val['News']['id'] ;?>')">
