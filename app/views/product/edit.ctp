				...
				<table width="84%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor" style="background-color:#FFFFFF;">
				  ...
				  <tr class="even_tr">
							...
							<select name="data[Product][producttype]" class="look">
								...
								if(is_array($prodtypearr)) {
									foreach($prodtypearr as $key=>$val) :
										if($val['Producttype']['id']==$edit_arr['Product']['producttype']) {
				   ...
				   <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Product.productname',array("class"=>"look","size"=>"60","value"=>$edit_arr['Product']['productname'])); ?>
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Product.price',array("class"=>"look","size"=>"60","value"=>$edit_arr['Product']['price'])); ?>
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						...
						<?php
								if($edit_arr['Product']['image']!="") {
									echo $img="<img src=".$this->webroot."img/productimage/".$edit_arr['Product']['image']." width=160 border=0 class=wrap>";
								}
								?>
						<br /><br />
					  	...
					  	<?php					  
							if(count($imagearr)>0) {
								...
								foreach($imagearr as $key=>$val):
									echo $img="<img src=".$this->webroot."img/additionalproimage/".$imagearr[$key]['tbl_additionalproductimages']['image']." width=80 border=0 class=wrap>";
									?>
										
									  <a href="<?php echo $html->url('/product/deladdimage/'.$imagearr[$key]['tbl_additionalproductimages']['id'].'/'.$imagearr[$key]['tbl_additionalproductimages']['image']) ;?>" class="view_link">
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Product.dimensions',array("class"=>"look","size"=>"60","value"=>$edit_arr['Product']['dimensions'])); ?>
				  ...
				  <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Product.length',array("class"=>"look","size"=>"60","value"=>$edit_arr['Product']['length'])); ?>
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->text('Product.width',array("class"=>"look","size"=>"60","value"=>$edit_arr['Product']['width'])); ?>
				 ...
				 <tr class="even_tr" style="padding:10px;">
					...
					<td width="70%" align="left" valign="top" class="smalltext">
						 <?php echo $form->textarea('Product.productdesc',array("class"=>"look","rows"=>"15","cols"=>65,"value"=>$edit_arr['Product']['productdesc'])); ?>
					</td>
				 </tr>	
