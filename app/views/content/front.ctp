	...
	<div id="wrapper_parrent">		
		...
		<div class="sub_body">			
				<div class="upper">
					...
					<br>
						<ul>
							<li class="find"><a href="<?php e($html->url('/horse/findahorse'));?>">Find</a></li>
							<li class="add"><a href="<?php e($html->url('/horse/addhorse'));?>">Add</a></li>
							<li class="sell"><a href="<?php e($html->url('/horse/mylistedhorse'));?>">Sell</a></li>
						</ul>
					</div>	
					</div>
