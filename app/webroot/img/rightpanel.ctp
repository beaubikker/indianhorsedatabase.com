...
<div class="visitor" style="position:absolute; top:165px">
						...
						<div class="vis_mid">
							...
							<form action="javascript:void%200;" onsubmit="return Chklogin()">
								...
								<input class="mass1" type="submit" value="Log in"  onclick="Chklogin()" style="cursor:pointer"/>
								<br /><span  style="padding-left:12px"><input type="checkbox" id="rem" value="Y" name="rem" <?php if(count($chkcookarr)>0) {?> checked="checked" <?php } ?>/> Remember Me </span>
								<br />
								<br />
