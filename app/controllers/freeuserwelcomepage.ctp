...
<script language="javascript">
	function seechange(horse_id) {
		...
		if(parseInt(horse_id)) {
			...
			document.getElementById("changeview").innerHTML="<br><img src=<?php e($this->webroot);?>img/ajax-loader.gif>";	
		...
		<div class="sub_body">			
				<div class="upper">	
					...
					?>												
						...
						<?php
						if(count($notificationarr)<=0 && count($liststablearr)<=0 && count($listuserarr)<=0 )  {?>
										...
										?>									
											<p class="box_text">
												<a href="<?php e($html->url('/stable/viewprofile/'.$val['Stable']['id']));?>" style="color:#CBBF84; text-decoration:none">
													...
													?> has changed an information for <?php e("<b>".$val['Stable']['stable_name']."</b>");?>.</a>
									...
									?>	
											...
											?>
												...
												foreach($changenotiarr as $key=>$val) :
													...
													?>									
																<p class="box_text">
																	A user has requested changes of <b><?php e($val['Changerequest']['name']);?></b>. Can you approve these changes?<br><br> <input type="button" class="newbutton" value="See Change" onClick="seechange('<?php e($val['Changerequest']['horse_id']);?>')">&nbsp;&nbsp;<a href="<?php e($html->url('/horse/acceptchange/'.$val['Changerequest']['horse_id'].'/'.$val['Changerequest']['id'].'/owner'));?>" style="color:#CBBF84; text-decoration:none">Yes </a> &nbsp;&nbsp;<a href="<?php e($html->url('/horse/reject/'.$val['Changerequest']['horse_id'].'/'.$val['Changerequest']['id'].'/owner')) ;?>" style="color:#CBBF84; text-decoration:none">No </a>
																</p>
													<?php
															}
														}
									...
									?>	
											...
											?>
												...
												foreach($breederarr as $key=>$val) :
													...
													?>									
																<p class="box_text">
																	A user has requested changes of <b><?php e($val['Changerequest']['name']);?></b>. Can you approve these changes?<br><br> <input type="button" class="newbutton" value="See Change" onClick="seechange('<?php e($val['Changerequest']['horse_id']);?>')">&nbsp;&nbsp;<a href="<?php e($html->url('/horse/acceptchange/'.$val['Changerequest']['horse_id'].'/'.$val['Changerequest']['id'].'/breeder'));?>" style="color:#CBBF84; text-decoration:none">Yes </a> &nbsp;&nbsp;<a href="<?php e($html->url('/horse/reject/'.$val['Changerequest']['horse_id'].'/'.$val['Changerequest']['id'].'/breeder')) ;?>" style="color:#CBBF84; text-decoration:none">No </a>
																</p>
													<?php	
																}
															}
										...
										<?php
											...
											?>
												...
												foreach($adderarr as $key=>$val) :
													...
													?>									
																<p class="box_text">
																	A user has requested changes of <b><?php e($val['Changerequest']['name']);?></b>. Can you approve these changes?<br><br> <input type="button" class="newbutton" value="See Change" onClick="seechange('<?php e($val['Changerequest']['horse_id']);?>')">&nbsp;&nbsp;<a href="<?php e($html->url('/horse/acceptchange/'.$val['Changerequest']['horse_id'].'/'.$val['Changerequest']['id'].'/adder'));?>" style="color:#CBBF84; text-decoration:none">Yes </a> &nbsp;&nbsp;<a href="<?php e($html->url('/horse/reject/'.$val['Changerequest']['horse_id'].'/'.$val['Changerequest']['id'].'/adder')) ;?>" style="color:#CBBF84; text-decoration:none">No </a>
																</p>
													<?php		
																}
															}
						...
						<div class="profile_info">
							...
							<div class="po_inf_mid">
								...
								<ul>
									<li><a href="<?php e($html->url('/user/updatemembership'));?>">Upgrade to Premium Membership</a></li>
									<li><a href="<?php e($html->url('/horse/addhorse'));?>">Add a new Horse</a></li>
									<li><a href="<?php e($html->url('/horse/mylistedhorsefreemember'));?>">View your added Horses</a></li>
									<li><a href="<?php e($html->url('/user/userfreeuseaccount'));?>">Edit your personal profile page.</a></li>									
								</ul>
							</div>
							<div class="po_inf_btm">&nbsp;</div>						
						</div>
...
<?php
	...
	<span id="changeview" style="display:none; position:absolute;left:20px;top:300px;padding: 15px; z-index:5000000" >
