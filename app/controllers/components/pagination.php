 ...
 * @return array 
 */ 
    function init($criteria=NULL,$parameters=Array(),$options=Array(), $rowCount = NULL)  # this rowCount is added by Saumava on 07/02/2008 
    { 		
	   	uses('sanitize'); 
		...
		/*echo $this->paging['Defaults']['show'] ;*/
		...
		if(isset($rowCount)) // isset() is inplemented on 16_06
			$count = $rowCount; 
        ...
        return (Array($this->order,$this->paging['show'],$this->paging['page'],$count)); 
    } 
